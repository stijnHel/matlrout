classdef cEclipsCalc < handle
	% cEclipsCalc - class combining eclipse related calculations
	...
	methods
		function c = cEclipsCalc(varargin)
		...
		function Plot(c,t,pos)
			...
			lS = findobj(gca,'Tag','sun');
			lM = findobj(gca,'Tag','moon');
